...
export class VehicleSystem {
  ...
  availableNear(x, radius=120) { return this.vehicles.find(v=>!v.destroyed && !v.claimedBy && Math.abs(v.x-x)<=radius) || null; }
  claim(vehicle, squad) { if (!vehicle || vehicle.destroyed || vehicle.claimedBy) return false; vehicle.claimedBy=squad.id; squad.vehicle=vehicle; return true; }
